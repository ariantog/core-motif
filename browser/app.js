...
const logos = [
  { title: 'Open Set', note: 'Recommended · broad and ownable', path: 'assets/logo/readable/01-open-set.png' },
  { title: 'Open Set + descriptor', note: 'ACTIVEWEAR / SURABAYA', path: 'assets/logo/readable/01-open-set-active.png' },
  { title: 'Open Set stacked', note: 'Square-space lockup', path: 'assets/logo/readable/01-open-set-stack.png' },
  { title: 'Core / Nation', note: 'Two weights · one readable name', path: 'assets/logo/readable/02-core-nation.png' },
